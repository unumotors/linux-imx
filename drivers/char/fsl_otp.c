...
static const struct of_device_id fsl_otp_dt_ids[] = {
	{ .compatible = "fsl,imx6q-otp", .data = (void *)&imx6q_data, },
	{ .compatible = "fsl,imx6sl-otp", .data = (void *)&imx6sl_data, },
	{ .compatible = "fsl,imx6sll-otp", .data = (void *)&imx6sll_data, },
	{ .compatible = "fsl,imx6ul-otp", .data = (void *)&imx6ul_data, },
	{ .compatible = "fsl,imx6ull-otp", .data = (void *)&imx6ull_data, },
	{ .compatible = "fsl,imx7d-otp", .data = (void *)&imx7d_data, },
	{ .compatible = "fsl,imx7ulp-otp", .data = (void *)&imx7ulp_data, },
	{ /* sentinel */ }
};
...
static int fsl_otp_probe(struct platform_device *pdev)
{
	...
	otp_base = of_iomap(ocotp_np, 0);
	of_node_put(ocotp_np);
	if (!otp_base) {
		dev_err(&pdev->dev, "failed to map ocotp\n");
		return -EFAULT;
	}
